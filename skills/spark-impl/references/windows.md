...
- Preserve an established Windows architecture. For a new implementation, mark unresolved consequential choices **Blocked** and direct the user to `/spark-config`.
