...
- Preserve an established iOS or cross-platform architecture. For a new implementation, mark unresolved consequential choices **Blocked** and direct the user to `/spark-config`.
