...
- Keep persistence an internal implementation choice unless a reviewed Spark, profile constraint, or independent Storage target defines it.
...
- Do not create UI, client, independent Storage, deployment, or test artifacts in this target.
