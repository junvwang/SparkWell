...
test('core project templates preserve the methodology quality contract', async () => {
  ...
  assert.match(implementationSkill, /authoritative order defined by `\.sparkwell\/implementation-profiles\.md` under \*\*Resolution and Conflicts\*\*/)
  ...
  assert.match(sparkConfigSkill, /Do not encode general architecture settings in YAML/)
  assert.doesNotMatch(sparkConfigSkill, /^Constraints:|^Preferences:|`constraints` for|`preferences` for/m)
